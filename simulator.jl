...
# ╔═╡ 46fe0caa-8a3f-4038-a3c4-41a3b451728c
#with_terminal() do
#@btime begin
	#kc = parameters[:kc]
	#compute_coh2(b,xv,yv,mag,cb,kc,p)
	#b[:,COH_X:COH_Y] ./= max.(b[:,COH_N], 1.)
#end
#end
...
#b1, parameters1 = load_swarm("/home/dk0/research/swarms/swarm_simulator/experiments/config/paper/gap_fill_no_rgf_hole_370.json")
